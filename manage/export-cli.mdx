...
description: "The Zapier Platform CLI (Command Line Interface) is a toolset you install and run in your local development environment. It allows you to build, test, and manage your Zapier integration through JavaScript code and terminal commands."
---
...
*   Access to all [features](/quickstart/ui-vs-cli) of the Zapier Platform
...
Follow the steps in the setup section in our [quickstart guide](/reference/cli-docs#quick-setup-guide)
...
<Frame>
  <img src="/images/c5e0c7f17a5ab52d9661e134394e9cc7.png"/>
</Frame>

Similarly, your version can be found there, and elsewhere throughout the Platform UI:
<Frame>
  <img src="/images/e31dd202b5e64bbcb13fc8b200518d17.png"/>
</Frame>
...
Check out the resources available in the [CLI section](/reference/cli-docs) of the docs to learn all about the Zapier CLI.
...
*   When you push the CLI project to the server it will create a _new version_ of your integration. If you haven’t gotten familiar with how versions work you might take a moment and learn about those [here](/manage/versions).
