...
description: "Our shared customers rely on Zapier and your integration for business-critical workflows. Addressing feedback early and often ensures users have the best experience, both with Zapier’s platform and yours. Follow these tips on how.
"
---
...
> Pro tip: Explore users’ most valued and widely used features per app category! Head over to our [must-have triggers and actions](/quickstart/must-have-triggers-and-actions) page for details.
...
*   [Leave a comment](/manage/user-feedback) on the Bugs & Feature Requests section inside your Partner Dashboard
...
*   Make staying on top of your open bugs and feature requests a priority by leveraging [Zapier Issue Manager](/manage/user-feedback#3-consider-zapier-issue-manager)
