...
description: "Once an integration is public, all users would have access to it when searching for an app’s name in the Zap Editor, or in the [Zapier App Directory](https://zapier.com/apps)."
---
...
*   In the _Integrations_ section, select your **integration**.
*   In the left sidebar, under _Manage_ click **Sharing**.
...
*   In the _Integrations_ section, select your **integration**.
*   In the left sidebar, under _Manage_ click **Sharing**.
*   In the _Email_ field, insert the **user’s email**.
*   (Optional) In the _Versions_ dropdown menu, select which **version** of your integration you want your user to access.
...
3.  In the _Integrations_ section, select your **integration**.
4.  In the left sidebar, under _Manage_ click **Sharing**.
