...
4.  On the version you want to promote, click the **three dots icon**
 ...
 and **Promote**.
5.  Fill in the [changelog form](/manage/user-feedback#3-close-resolved-issues) and click **Promote**. Selecting specific features added and bugs fixed will automatically queue up the issue(s) to be reviewed by our internal team for closure.

> **Note**: If you have a private integration, you will not see the _Promote_ option. Instead, you can [share your new version](/manage/sharing) with users.
