...
<Frame>
  <img src="/images/79bb2a1ea31a301f286e07e209994dcd.png"/>
</Frame>
...
> **Note**: Zapier recommends to understand [versioning model of the Platform UI](/manage/versions) before making any code changes.
...
*   **Scripting**: The legacy Web Builder combined all code into one Scripting page that let you add custom code for authentication, triggers, actions, and response data parsing. If you add new triggers or actions to your integration, though, use [Code Mode](/build/code-mode) to customize your API call or response bundle parsing. Learn more in [legacy scripting](https://platform.zapier.com/legacy/scripting).
...
<Frame>
  <img src="/images/27b0a08799b047fc9db1ed204d030377.gif"/>
</Frame>
...
Field names and structure of the Bundle is slightly different between the Legacy Web Builder and the new platform. Learn more details in our [Bundle docs](/reference/cli-docs#bundle-object).
