...
description: "Form and survey app integrations built on Zapier allow users to connect mobile data collection forms to send the responses into other apps as new contacts, document templates, messages, and more."
---
...
<Frame>
  <img src="/images/d5a605fafa8aaa679f86bca3655ce0d9.png"/>
</Frame>

## 2\. Configure selection of a specific form

*   Add a [dynamic dropdown](/build/field-definitions#how-to-add-dynamic-and-custom-fields) to retrieve form names exactly as they are listed in your app.
...
<Frame>
  <img src="/images/79158aee580d74c8241e1375e73f91db.gif"/>
</Frame>
...
<Frame>
  <img src="/images/ae9c0c297710e3bce8385f5d5a7b468f.png"/>
</Frame>
...
<Frame>
  <img src="/images/033953ce0537c18a6efbe47f783ddf5a.png"/>
</Frame>
...
<Frame>
  <img src="/images/e922d705c9f9d61c46f32b31ba03e53f.png"/>
</Frame>
...
<Frame>
  <img src="/images/a71b26a4a333fa9cb6b4a8c77607c426.png"/>
</Frame>
...
<Frame>
  <img src="/images/02fd5f03f00a7e3c6953c95366013473.png"/>
</Frame>

### Date fields

*   Return the timestamp when the response was completed in [ISO 8601 format](/publish/branding-guidelines#output-data). Also return any dates users can select in the form or survey in ISO 8601 format.
...
<Frame>
  <img src="/images/762d2661a3da2d4a689052e316091f42.png"/>
</Frame>
...
*   You could configure Zapier to request the full file via [file dehydration](https://github.com/zapier/zapier-platform/blob/main/packages/cli/README.md#file-dehydration) but you’ll need to then work in the [Platform CLI](/quickstart/cli-tutorial).
...
*   If your app supports webhook subscriptions that can be manipulated through a REST API, use [REST hooks](/build/trigger#rest-hook-trigger) for your trigger to send new form entries to Zapier as soon as the form is filled out.
