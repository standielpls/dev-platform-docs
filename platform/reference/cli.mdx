...
Job stages will then move to “estimating”, “in\_progress” and finally one of four “end” stages: “complete”, “aborted”, “errored” or “paused”.
...
After a promotion, go to your developer platform to [close issues that were resolved](/manage/user-feedback#3-close-resolved-issues) in the updated version.
...
[Previous: Zapier Platform CLI docs](/reference/cli-docs) [Next: Transfer](/reference/transfer)
