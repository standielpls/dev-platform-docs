...
After a promotion, go to your developer platform to [close issues that were resolved](/platform/manage/user-feedback#3-close-resolved-issues) in the updated version.
