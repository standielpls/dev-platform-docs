...
*   Use `z.generateCallbackUrl()` and `performResume`
    ...
    *   [Documentation](/platform/reference/cli-docs#zgeneratecallbackurl)
...
*   Use `bundle.meta.isLoadingSample`:
    ...
    *   [Documentation](/platform/reference/cli-docs#bundlemeta)
...
*   Use Custom Input Fields:
    ...
    *   [Documentation](/platform/reference/cli-docs#customdynamic-fields)
