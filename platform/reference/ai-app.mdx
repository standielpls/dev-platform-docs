...
description: AI app integrations built on Zapier allow users to automate tasks using AI capabilities. Here are some common pain points and recommendations when building AI apps on Zapier.
---
## Pain Points
...
*   Use `z.generateCallbackUrl()` and `performResume`
    ...
    *   [Documentation](/reference/cli-docs#zgeneratecallbackurl)
...
*   Use `bundle.meta.isLoadingSample`:
    ...
    *   [Documentation](/reference/cli-docs#bundlemeta)
...
*   Use Custom Input Fields:
    ...
    *   [Documentation](/reference/cli-docs#customdynamic-fields)
...
*   Provide [Zap Templates](/publish/zap-templates):
