...
<CardGroup cols={3}>
  ...
  <Card
    title="CLI Reference"
    icon="book-open"
    href="https://github.com/zapier/zapier-platform/blob/main/packages/cli/docs/cli.md"
    horizontal
  /> <Card
    title="Schema Reference"
    icon="code"
    href="https://github.com/zapier/zapier-platform/blob/main/packages/schema/docs/build/schema.md"
    horizontal
  />{" "}
</CardGroup>
