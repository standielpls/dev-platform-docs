...
To edit branding, select the gear icon in the upper left hand corner near your app’s name and placeholder icon. Edit your integration’s name and description, and upload your app’s logo (a square, transparent PNG at least 256x256px), meeting [requirements](/publish/branding-guidelines). Below that, set your app’s Intended Audience, your role and the app’s category. Select _Save_.
