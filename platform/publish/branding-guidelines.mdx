...
App profile pages include [Zap Templates](/publish/zap-templates), predefined and curated examples of popular integration use cases with pre-mapped fields that users can set up in a few clicks.
