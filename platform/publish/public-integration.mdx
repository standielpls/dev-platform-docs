...
*   You’ll get support from [Zapier’s Partner Program](/publish/partner-program) once your app has been successfully reviewed.
...
Consider workflows your app will support, and what types of activities your users want to automate. Learn [how Zapier works](/quickstart/how-zapier-works) and set up a few Zaps to get a sense of the user experience.
...
Learn more about [recommendeded integration features](/quickstart/must-have-triggers-and-actions) by app category and how to design [popular app type integrations](/quickstart/must-have-triggers-and-actions).
...
Learn more about the difference between building with the [Platform UI and the CLI](/quickstart/ui-vs-cli).
...
*   [Testing using Zapier Platform UI](/build/test-auth)
...
Before submitting your integration, review [Zapier’s integration publishing requirements](/publish/integration-publishing-requirements) or ask the [PublishBot](https://publishbot.zapier.app/) for a smoother app review process.
...
As soon as your app is published and in beta you can begin creating and sharing [Zap Templates](/publish/zap-templates). Zap Templates are readymade integrations or Zaps with the apps and core fields pre-selected. In a few clicks, they help people discover a use case, connect apps, and turn on the Zap.

Learn more about creating [Zap templates](/publish/zap-templates).
...
Learn more strategy [tips for a successful integration](/publish/partner-faq).
...
Learn more about [Zapier Issue Manager](/manage/user-feedback).
...
Learn more about [maintaining your Zapier integration](/manage/user-feedback).
