...
description: When building in the Platform UI, you’ll use the Input Designer to create the form users will input data into, to send to your app’s API.
---
...
<Frame> <img src="/images/524b9300c044809eb13eb732d7a50f9d.png" /> </Frame>
...
*   **Type**: From the dropdown menu, select type of data you want user’s to enter. Learn more in [field definitions and types](/build/field-definitions):
    *   String
    *   Text
    *   Integer
    *   Number
...
<Frame> <img src="/images/f8d0fd74582dc7c5997248516ad50d4f.png" /> </Frame>
...
<Frame> <img src="/images/bf4c2a6ad55c12f6e3079e50f5d38e6c.png" /> </Frame>

That will add another entry row to allow the user to input another entry for that field. An [array containing a comma separated list of entries](/images/95938b473edfee13663161ee3c8e5ea4.png) is sent in the API request. Never ask users to type in a comma separated list, rather use this functionality.

### Alters dynamic fields

For each [dynamic field](/build/dynamic-field) in your integration, Zapier runs code to decide whether to show a field or what to show in a field.
...
<Frame> <img src="/images/f89ed93d7233d0473b435156b31a1a8a.png" /> </Frame>
...
<Frame> <img src="/images/4f65bd28634d7709cac0ba84f2fa73d3.png" /> </Frame>
...
<Frame> <img src="/images/101618614c22bd4bd453c365db753db9.png" /> </Frame>
...
<Frame> <img src="/images/b1892fb8ea92e7d21ec0b356f7e3330b.png" /> </Frame>

<Frame> <img src="/images/886425bb6592ab9e4141b15e3cc001ec.png" /> </Frame>

#### Dynamic Dropdown

If users need to select data from their account in your app — such as a project, folder, team member, or other user-specific detail with a corresponding ID — then you would use a dynamic dropdown. For dynamic dropdowns, Zapier first fetches data from your API and then displays it in a menu. Never make users type in an ID number, rather use this functionality or [add a search action](/build/search) to find the ID number automatically.
...
<Frame> <img src="/images/36d19e02a566c61c3df00e7b6987daf1.png" /> </Frame>
...
<Frame> <img src="/images/e7dd5bf7e40caa03989e754ca518d14c.png" /> </Frame>
...
<Frame> <img src="/images/81be9d8ede3b19a8d4b5f58125575076.png" /> </Frame>
If your API supports pagination, you can allow users to load additional data in the menu by checking the _Support Paging_ box. The first API call might pull in 20 items; if the user requests additional items, Zapier would call the API again and request the second page for the next 20 items. _per\_page_ and _limit_ are common parameters to indicate how many items to pull (controlling the page size). Confirm which parameter to use from your API’s documentation.

Customize the pagination using [Code Mode](/build/code-mode). Learn more about [how to use pagination in triggers](/build/trigger#how-to-use-pagination).
...
<Frame> <img src="/images/3023ea97191fbcf90222dcf42a46035d.png" /> </Frame>
...
<Frame> <img src="/images/f2a8c7071bf4e96e5a44073999b4ccf5.png" /> </Frame>

Select the field with the data your API needs for this action in the _Field Name_ menu, and the field with a human-friendly name for the data in the _Field Label_ menu. The [preview will indicate the presence of the field](/images/4780bb34f2f3d24062d2eb556ed1e3a9.png), but you will need to use your trigger/action in a Zap to test the menu and pull in real data.
...
<Frame> <img src="/images/afacb9fb44654908ec3d9e6803b728ee.png" /> </Frame>

It is important to provide the API value (example `id`) for users to know what type of data the field expects. Users can also choose to [enter a custom value](/images/f72a12759a3b3b391025f6500f6c7904.png)
...
<Frame> <img src="/images/51ef24ac9ee90dd393e695ec75601532.png" /> </Frame>

You’ll need to add a [Search Action](/build/action#how-to-add-a-search-action) to find the items used in this dropdown menu. Then check the _Add a search to this field_ option under the dynamic dropdown you’ve built, choose that action, and enter the ID of the field from that trigger that Zapier needs to pass with this API call (which should include the same data as the _Field Name_ you selected before for the dynamic menu).
<Frame> <img src="/images/3f6203d975653bcd004dccb5f15424ed.png" /> </Frame>
...
<Frame> <img src="/images/08bf5a61391edb66c9a5f5bad37e2889.png" /> </Frame>

In your trigger or action settings:

1.  Click the **Input Designer** tab.
2.  In the _Sort_ column, click the **up**
<Frame> <img src="/images/7b756b685e0e7f9759e8f7e1ed700aca.png" /> </Frame>
or **down** <Frame> <img src="/images/f596f26128d01efe179c4340f0d17f84.png" /> </Frame> arrow to move the fields to the order you want in the Form Editor screen.
...
Make sure to delete only unnecessary fields, as a previous version of the input form cannot be restored. You cannot remove input fields from public integrations; you must [create a new version of your integration](/manage/versions) before changing input fields and [consider the impacts of the change](/manage/planning-changes#changing-form-field-keys).

In your trigger or action settings:

1.  Click the **Input Designer** tab.
2.  Click the **gear icon** <Frame> <img src="/images/1397c67b31689803185dca4e04858e37.png" /> </Frame> beside the input field you want to delete.
3.  Click **Delete**.
