...
<Frame>
  <img src="/images/024547d6df8622335ca65456c6d0a11c.png"/>
</Frame>

Triggers only watch for new data and typically send no or little data to your app. They are often quicker to set up than Zapier [actions](/build/action).
