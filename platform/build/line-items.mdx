...
9.  Add in the relevant fields as you would for a [input field](/platform/build/field-definitions#add-fields). Each field that you add here will be received as line item values. Note the _Allows Multiples_ and _Alters Dynamic Field_ options will not appear as those options cannot be used in line item fields as they are mutually exclusive.
