...
2.  **[Contact Zapier Support](https://developer.zapier.com/contact)**: They can help you enable static IP addresses for any public or private app integration you are an [Admin](/manage/add-team) for. The turnaround time is typically within 1 business day.
