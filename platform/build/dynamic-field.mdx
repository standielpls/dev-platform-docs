...
description: "Dynamic fields are a type of field built from an API call. Custom code runs to show fields based on other input field data. These are especially useful with project management apps, CRM apps, databases, and any other app where users can add custom, user-defined fields."
---
...
*   Whenever the _Set up_ section for the action is opened in the Zap editor.
*   Whenever the _Refresh Fields_ button is used on the action.
...
<Frame>
  <img src="/images/8177dce9ee77e014b8fe65f4f6d6e5ba.png"/>
</Frame>
