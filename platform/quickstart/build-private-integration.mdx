...
description: 'This guide will walk you through what steps you need to take to build a [private integration](/platform/quickstart/private-vs-public-integrations) from start to finish. There are no fees to build an integration with Zapier.'
---
