---
title: Build your first private integration on Zapier
sidebarTitle: Introduction
description: 'This guide will walk you through what steps you need to take to build a [private integration](/quickstart/private-vs-public-integrations) from start to finish. There are no fees to build an integration with Zapier.'
---

You can choose to build with either [Zapier Platform UI or Zapier Platform CLI](/quickstart/ui-vs-cli).
...
Select [one of the two ways](/quickstart/ui-vs-cli) to build an integration on Zapier’s Platform.
...
Both of these tools run on the same Zapier platform, so choose the one that fits your workflow the best. You can try both methods out with the [Platform UI tutorial](/quickstart/ui-tutorial) and the [Platform CLI tutorial](/quickstart/cli-tutorial).
...
*   [Authentication using Zapier Platform UI](/build/auth)
...
*   [Configure a trigger using Zapier Platform UI](/build/trigger)
...
*   [Create an action using Zapier Platform UI](/build/action)
...
*   [Run automated checks using Zapier Platform UI](/publish/integration-checks-reference)
...
*   [Invite team members using Zapier Platform UI](/manage/add-team)
...
*   [Share your integration](/manage/sharing)

## 10\. Conclusion

Once you’ve built your private integration, continue to make further improvements and manage versions of your integration.

*   [Manage integration versions using Zapier Platform UI](/manage/versions#managing-versions-in-platform-ui)
*   [Manage integration versions using Zapier Platform CLI](/manage/versions#managing-versions-in-platform-cli)
