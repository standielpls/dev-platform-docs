...
From the Zapier CLI, run: `zapier team:add user@example.com admin` to invite a team member [as an admin](/platform/manage/add-team#admin) for the app.

OR

`zapier team:add user@example.com collaborator` to invite a team member [as a collaborator](/platform/manage/add-team#collaborator) for the app.
