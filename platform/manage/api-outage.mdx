---
Title: Prepare for API outages
description: "Zapier recognizes that temporary unavailability is sometimes inevitable for your API."
---
...
When building in the [UI](https://developer.zapier.com/), custom error handling needs to be added to each individual element of the integration (authentication, triggers, actions) using [Code Mode](/build/code-mode).
...
```
<Frame>
  <img src="/images/f9f04386f19f0e9f7f107ea8d0d6e3b7.png"/>
</Frame>

> **Note:** Integrations built with the Zapier Platform UI can enable the _skipThrowForStatus_ toggle under [Advanced/Settings](/build/errors) to On to use [`skipThrowForStatus:true`](https://cdn.zappy.app/8ac6af91f6b27c4a473d566f1534b27e.png) on every request
...
<Frame>
  <img src="/images/2ae85a1cd6d00981ed30af8eede5938b.png"/>
</Frame>
