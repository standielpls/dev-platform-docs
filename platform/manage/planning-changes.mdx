...
| **Authentication schemes** | [BREAKING CHANGE](/manage/auth-scheme) | \-  | [BREAKING CHANGE](/manage/auth-scheme) | \-  | <Icon icon="check"/>   |
| **Authentication fields - required** | [BREAKING CHANGE](/manage/auth-required) | [Depends](/manage/auth-required) | \-  | <Icon icon="check"/>   | \-  |
| **Authentication fields - optional** | <Icon icon="check"/>   | <Icon icon="check"/>   | \-  | <Icon icon="check"/>   | \-  |
| **Authentication field key(s)** | \-  | [BREAKING CHANGE](/manage/auth-keys) | \-  | \-  | \-  |
...
| **Trigger/Action - key** | \-  | [BREAKING CHANGE](/manage/change-keys) | [BREAKING CHANGE](/manage/change-keys) | \-  | <Icon icon="check"/>   |
| **Trigger/Action - input field(s) - required** | [Depends](/manage/required-input) | [Depends](/manage/required-input) | [Depends](/manage/required-input) | <Icon icon="check"/>   | \-  |
| **Trigger/Action - input field(s) - optional** | <Icon icon="check"/>   | <Icon icon="check"/>   | <Icon icon="check"/>   | <Icon icon="check"/>   | \-  |
| **Trigger/Action - input field(s) - key** | \-  | [BREAKING CHANGE](/manage/input-key) | [BREAKING CHANGE](/manage/input-key) | \-  | \-  |
| **Trigger/Action - input field(s) - field type** | \-  | Depends | Depends | \-  | \-  |
| **Trigger/Action - output data - key(s)** | <Icon icon="check"/>   | [BREAKING CHANGE](/manage/output-key) | [BREAKING CHANGE](/manage/output-key) | [BREAKING CHANGE](/manage/output-key) | \-  |
| **Trigger/Action - output data - response structure** | \-  | [BREAKING CHANGE](/manage/output) | [BREAKING CHANGE](/manage/output) | \-  | \-  |
| **Trigger/Action - perform function** | \-  | Depends | Depends | \-  | \-  |
| **Trigger type - polling to hook type** | \-  | [BREAKING CHANGE](/manage/change-trigger) | \-  | \-  | <Icon icon="check"/>   |
| **Trigger (polling) - perform function** | \-  | [Depends](/manage/change-perform) | [Depends](/manage/change-perform) | \-  | \-  |
...
| **Export UI to CLI** | \-  | [Depends](/manage/export-cli) | <Icon icon="check"/>   | \-  | \-  |
| **Export CLI to UI** | \-  | [Depends](/manage/export-ui) | \-  | \-  | \-  |
| **Edit Legacy Web Builder integration** | \-  | [Depends](/manage/versions-legacy) | [Depends](/manage/versions-legacy) | \-  | \-  |
