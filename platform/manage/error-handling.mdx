...
description: "Errors from your API cause pain for users at two vital points:"
---
...
In the UI, `skipThrowForStatus` is set from the [Advanced tab](/build/errors). This allows for custom error handling for status codes above 400. Note that 401 status codes will throw a `RefreshAuthError` [regardless](https://github.com/zapier/zapier-platform/blob/main/packages/cli/README.md#user-content-error-response-handling).
<Frame>
  <img src="/images/8cafa443c6e5844d6881f2690e4f34c5.png"/>
</Frame>
