...
description: "When you make a new integration in Zapier CLI, you can add the app’s name, description, and homepage to the `package.json` file."
---
<Frame>
  <img src="/images/5373ba1686dbea3e9d942b56101a5b40.png"/>
</Frame>
