...
*   Understanding of [Platform UI authentication configuration](/build/auth)
...
8.  Complete the rest of the relevant fields. Learn more in [Input Designer](/build/field-definitions).
9.  Click **Save**.
10.  You can then reference the field in any subsequent API call from the input bundle. In [Code Mode](/build/code-mode), you replace `field` with your field key in this text `{{bundle.authData.field}}`
