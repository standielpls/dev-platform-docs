...
6.  When testing a [REST Hook trigger](/build/hook-trigger), you will instead have to create and test a Zap in the Zap Editor as follows:
...
It is recommended that you check the logs in the [Monitoring](/build/test-monitoring) component for feedback from your Zap testing.
