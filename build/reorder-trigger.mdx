...
description: "Triggers are listed in alphabetical order in the Zap editor and this order cannot be changed."
---
## Reordering triggers
...
<Frame>
  <img src="/images/51c3b8911b5384ddf03b9dbfffd40050.png"/>
</Frame>
...
> Note: It is best practice to not remove a trigger that has been used in a live integration version. If a trigger is in use, it is recommended to [hide it rather than deleting it](/manage/planning-changes#updates-to-triggeractionsearch-keys). Only remove unused triggers from staging or development versions.
...
<Frame>
  <img src="/images/fc65459abad8ac60504f6085078bb361.png"/>
</Frame>
