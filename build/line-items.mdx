...
description: "Input fields in Zapier add one item each time the Zap runs. But, if you want users to be able to add multiple items in a single Zap run, then this can be achieved by using a line item group. This group takes line items, which are comma-separated values, and adds each instance of the values to the app in a single Zap run."
---
...
*   You should have already added an [action](/build/action) where this line item group would be added.
...
9.  Add in the relevant fields as you would for a [input field](/build/field-definitions#add-fields). Each field that you add here will be received as line item values. Note the _Allows Multiples_ and _Alters Dynamic Field_ options will not appear as those options cannot be used in line item fields as they are mutually exclusive.
...
<Frame>
  <img src="/images/41f81ef42d5101767810a9ffc5626e95.png"/>
</Frame>
...
<Frame>
  <img src="/images/533efc7f7719fa85587f72b04204371f.png"/>
</Frame>
<Frame>
  <img src="/images/a7bad08984545eb39e96ed2782660737.png"/>
</Frame>
